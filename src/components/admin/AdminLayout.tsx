  ...
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <header className="lg:hidden flex items-center justify-between border-b bg-background px-4 py-3">
        <Link to="/admin" className="font-bold text-xl text-primary font-display">
          I D N S <span className="text-xs uppercase tracking-widest text-muted-foreground font-sans">Admin</span>
        </Link>
        <Button
          variant="ghost"
          size="icon"
